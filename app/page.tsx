  ...
  return <SiteShell title="Experiencia completa">
    <section className="hero" id="inicio">
      ...
      <div className="hero-content">
        ...
        <div className="hero-actions"><Link className="primary-button" href="/planes">Encuentra tu plan <ArrowRight size={18} /></Link><Link className="secondary-button" href="/planes#asesor"><MessageCircle size={18} /> Hablar con un asesor</Link><Link className="client-button" href="/cliente"><UserRound size={18} /> Ya soy cliente</Link></div>
